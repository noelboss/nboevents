...
$TCA['tx_nboevents_domain_model_person'] = array(
	...
	'interface' => array(
		...
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, firstname, lastname, email, phone, phonemobile, phonecompany, address, city, note, reservations',
	),
	'types' => array(
		'1' => array('showitem' => 'gender, firstname, lastname, email, phone, phonemobile, phonecompany, street, city, address, note, reservations'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'street' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:nboevents/Resources/Private/Language/locallang_db.xml:tx_nboevents_domain_model_person.street',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'required,trim'
		...
		'city' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:nboevents/Resources/Private/Language/locallang_db.xml:tx_nboevents_domain_model_person.city',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'required,trim'
		...
		'note' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:nboevents/Resources/Private/Language/locallang_db.xml:tx_nboevents_domain_model_person.note',
			'config' => array(
				'type' => 'text',
				'cols' => 40,
				'rows' => 5,
