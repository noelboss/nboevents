...
$TCA['tx_nboevents_domain_model_course'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, title, description, price, events, categories, images',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, title, description, price, images, events, categories,--div--;LLL:EXT:cms/locallang_ttc.xml:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'events' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'ORDER BY tx_nboevents_domain_model_event.date',
				'maxitems'      => 9999,
				'appearance' => array(
					'collapse' => 0,
		...
		'categories' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:nboevents/Resources/Private/Language/locallang_db.xml:tx_nboevents_domain_model_course.categories',
			'config' => array(
				'type' => 'select',
